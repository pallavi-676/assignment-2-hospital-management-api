...
import { HeartPulse, Lock, User, Mail, Eye, EyeOff, ArrowRight, AlertCircle } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FDFD] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#E6F6F7]/50 rounded-full blur-3xl pointer-events-none -z-10" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#CCEEF0]/30 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-1.5 text-center text-xs text-[#5A7175]">
          Register as an administrator to manage hospital capacity.
        </p>
      </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-3.5 py-2.5 rounded-xl bg-white border text-sm text-[#0B2B2F] placeholder-[#8FA8AB] focus:outline-none focus:ring-2 focus:ring-[#0D5C63]/20 focus:border-[#0D5C63] transition-all ${
                    errors.email ? 'border-[#DC2626]' : 'border-[#E0EEEE]'
                  }`}
                  disabled={submitting}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-3.5 py-2.5 rounded-xl bg-white border text-sm text-[#0B2B2F] placeholder-[#8FA8AB] focus:outline-none focus:ring-2 focus:ring-[#0D5C63]/20 focus:border-[#0D5C63] transition-all ${
                    errors.confirmPassword ? 'border-[#DC2626]' : 'border-[#E0EEEE]'
                  }`}
                  disabled={submitting}
                />
              </div>
